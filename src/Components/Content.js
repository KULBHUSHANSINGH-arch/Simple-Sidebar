import React from 'react';
  ...
  function Content() {
    return (
       <div>
          ...
          <div class="container">
            <div class="row">
             ...
             <div class="row" style={{marginLeft:"23px"}} >
                <p class="mt-4  mb-9 right" >Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
        ...
        <section class="" id="destinations">   
            <div class="container">
                <div class="row">
                <div class="col-sm-10 "> 
                    <h3 class="text-center  text-secondary mt-4 " >Favourite Destinations</h3>
                </div> 
       ...
       <div class="accordion md-2 " id="accordionExample">
        <div class="card">
